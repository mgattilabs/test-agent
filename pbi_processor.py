...
class ExtractPBIsSignature(dspy.Signature):
    ...
    # Instructions
        ...
        Elenco dei Product Backlog Items (PBI) estratti dal riassunto.
        Il titolo deve essere breve e conciso, la descrizione dettagliata.
        I pbi troppo lunghi o complessi in più pbi.
    """
